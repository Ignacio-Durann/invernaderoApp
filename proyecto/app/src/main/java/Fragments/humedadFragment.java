...
public class humedadFragment extends Fragment {
    public RecyclerView rvSensorHumedad;
    String lista[][];
    ...
    public static humedadFragment getInstance(String param1, String param2){
        humedadFragment humedadF = new humedadFragment();
        return humedadF;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.humendad_fragment,container,false);
        rvSensorHumedad = (RecyclerView) view.findViewById(R.id.rv_sensor_humedad);
        rvSensorHumedad.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false));
        llenarSensorHumedad();
        return view;
    }

    private void llenarSensorHumedad() {
        try {
            String url = Uri.parse(conecxion.URL + "sensorh.php")
                    .buildUpon()
                    .build().toString();
    ...
    private void llenarRespuesta(JSONArray response) {
        try {
            ...
            rvSensorHumedad.setAdapter(new adaptador(lista));
